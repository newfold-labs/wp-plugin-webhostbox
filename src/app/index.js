...
const AppBody = ( props ) => {
	...
	return (
		<main
			id="wpwhb-app-rendered"
			className={ classNames(
				'wpadmin-brand-web',
				`wpwhb-wp-${ NewfoldRuntime.wpVersion }`,
				`wpwhb-page-${ kebabCase( location.pathname ) }`,
				props.className,
		...
		>
			...
			/>
			<div className="wpwhb-app-body">
				<div className="wpwhb-app-body-inner">
			...
			<div className="wpwhb-app-snackbar">
...
export const App = () => (
	<AppStoreProvider>
		<Root context={{ isRtl: false }}>
			<NotificationFeed>
				<Router>
					<div className="wpwhb-app-container nfd-flex nfd-flex-col">
						<AppNav />
						<AppBody />
					</div>
				</Router>
