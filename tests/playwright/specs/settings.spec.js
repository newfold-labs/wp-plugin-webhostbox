...
test.describe('Settings Page', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    await auth.navigateToAdminPage(page, 'admin.php?page=webhostbox#/settings');
  });
  ...
  test('Is Accessible', async ({ page }) => {
    ...
    await page.waitForSelector('.wpwhb-app-body', { timeout: 10000 });
  ...
  test('Has Coming Soon Section', async ({ page }) => {
    const comingSoonSection = page.locator('.wpwhb-app-settings-coming-soon');
  ...
  test('Autoupdate Toggles function properly', async ({ page }) => {
    const updatesSection = page.locator('.wpwhb-app-settings-update');
...
test('Comment Settings Work', async ({ page }) => {
    const commentsSection = page.locator('.wpwhb-app-settings-comments');
